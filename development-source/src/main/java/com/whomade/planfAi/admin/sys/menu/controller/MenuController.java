...
import com.whomade.planfAi.admin.sys.menu.service.MenuService;
import com.whomade.planfAi.admin.sys.menu.vo.MenuVo;
...
public class MenuController {
    ...
    public ResponseEntity<java.util.List<MenuVo>> getUserMenus(
        ...
        com.whomade.planfAi.admin.sys.common.vo.UserInfoVo user = (com.whomade.planfAi.admin.sys.common.vo.UserInfoVo) session
