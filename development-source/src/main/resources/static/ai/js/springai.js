...
springai.addUserQuestion = function (question, chatPanelId) {
  const html = `
    <div class="d-flex justify-content-end m-2">
      <table>
        <tr>
          <td><img src="/ai/image/user.png" width="30"/></td>
...
springai.addAnswerPlaceHolder = function (chatPanelId) {
  ...
  let html = `
    <div class="d-flex justify-content-start border-bottom m-2">
      <table>
        <tr>
          <td><img src="/ai/image/assistant.png" width="50"/></td>
        ...
        <tr>
          ...
          <td>
            <div id="${uuid}-speaker" class="speakerPulse" 
              ...
              background: url('/ai/image/speaker-yellow.png') no-repeat center center / contain;"></div>
          </td>
          <td><span id="${uuid}"></span></td>
        </tr>
      </table>                      
      ...
      <table>
        <tr>
          ...
          <td>
            <div id="${uuid}-speaker" class="speakerPulse" 
              style="width: 30px; height: 30px; 
              background: url('/ai/image/speaker-green.png') no-repeat center center / contain;"></div>
          </td>
          <td><span id="${uuid}"></span></td>
        </tr>
      </table>            
